    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (type.equals("Movies added by users"))
        	...
        	if (filter_year)
        		...
        		q = new Query("Top250").addSort("rank", SortDirection.ASCENDING);
        }
        ...
        for (Entity result : pq.asIterable()) {
            ...
            if (filter_genre && filter_director) {
            	if (q_genre.toLowerCase().contains(genre.toLowerCase())
            		...
            		write.print("<p>" + rank + "<a target=\"_blank\" href=\"http://www.imdb.com/title/" + id + "\">" + title + "</a> (" + year + "). <b>Director:</b> " + q_director + ". <b>Genre:</b> " + q_genre + ". <b>Rating:</b> " + rating + "/10.</p>");
            }
